...
extension ServiceEntry {
    ...
    @discardableResult
    public func implements<T1, T2, T3, T4>(
        _ type1: T1.Type,
        _ type2: T2.Type,
        _ type3: T3.Type,
        _ type4: T4.Type
    ...
    @discardableResult
    public func implements<T1, T2, T3, T4, T5>(
        _ type1: T1.Type,
        _ type2: T2.Type,
        _ type3: T3.Type,
        _ type4: T4.Type,
    ...
    @discardableResult
    public func implements<T1, T2, T3, T4, T5, T6>(
        _ type1: T1.Type,
        _ type2: T2.Type,
        _ type3: T3.Type,
        _ type4: T4.Type,
        ...
        return implements(type1).implements(type2).implements(type3).implements(type4).implements(type5).implements(
            type6
        )
    }
    ...
    @discardableResult
    public func implements<T1, T2, T3, T4, T5, T6, T7>(
        _ type1: T1.Type,
        _ type2: T2.Type,
        _ type3: T3.Type,
        _ type4: T4.Type,
    ...
    @discardableResult
    public func implements<T1, T2, T3, T4, T5, T6, T7, T8>(
        _ type1: T1.Type,
        _ type2: T2.Type,
        _ type3: T3.Type,
        _ type4: T4.Type,
        ...
        return implements(type1).implements(type2).implements(type3).implements(type4).implements(type5).implements(
            type6
        ).implements(type7).implements(type8)
    }
    ...
    @discardableResult
    public func implements<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
        _ type1: T1.Type,
        _ type2: T2.Type,
        _ type3: T3.Type,
        _ type4: T4.Type,
